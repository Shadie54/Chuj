...
class TesterScreen:
    ...
    def _build_sidebar_rects() -> dict[str, pygame.Rect]:
        ...
        btn("next")
        btn("back")
        # AI toggle (sweep toggle zmazaný — sweep v2 je teraz jediný systém)
        rects["ai_toggle"] = pygame.Rect(x, y, SB_INNER_W, SB_BTN_H)
    ...
    def _draw_sidebar(self):
        ...
        # AI systém toggle (sweep toggle zmazaný — sweep v2 je teraz jediný systém)

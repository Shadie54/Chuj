...
DECLARATION_NONE_BONUS = -10        # nechytím ani jeden štich
DECLARATION_FAIL_PENALTY = 10       # dostanem +10b ak záväzok nesplním
...
BUTTON_INFO_WIDTH = BUTTON_W
BUTTON_INFO_HEIGHT = BUTTON_H

BUTTON_MENU_X = BUTTON_X
...
ROUND_STATUS_W = 350
ROUND_STATUS_H = 260
ROUND_STATUS_X = SCREEN_WIDTH - 370
